...
mbpt3V02::mbpt3V02(Input_Parameters &parameters, Model_Space &space, Channels &channels) {
  mbpt3V02::name = "mbpt3V02";
  mbpt3V02::modelspace = space;
  mbpt3V02::channels = channels;

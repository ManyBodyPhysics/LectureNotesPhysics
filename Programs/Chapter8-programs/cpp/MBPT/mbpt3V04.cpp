...
mbpt3V04::mbpt3V04(Input_Parameters &parameters, Model_Space &space, Channels &channels) {
  mbpt3V04::name = "mbpt3V04";
  mbpt3V04::modelspace = space;
  mbpt3V04::channels = channels;

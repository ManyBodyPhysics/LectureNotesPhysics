...
In figure \ref{fig:imsrg_corr}, we show the IMSRG(2) correlation energy
\begin{equation}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{\label{sec:perspectives}Current Developments}
...
% SUBSECTION %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{\label{sec:magnus}Magnus Expansion and Effective Operators}
...
\begin{figure}[t]
\begin{center}
\includegraphics[width=.6\columnwidth]{\fdir/O16_n2loSAT_eMax8_hw24_ground_state.pdf}
\caption{\label{fig:timestep_O16}
(Color online) IM-SRG(2) and Magnus(2) ground-state energy of $\nuc{O}{16}$, 
...
% calculations (see section \ref{sec:groundstate}).
...
% to open-shell nuclei (see section \ref{sec:groundstate}) is the 

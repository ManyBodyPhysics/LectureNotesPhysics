...
% SUBSUBSECTION %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
\subsubsection{The Off-Diagonal Hamiltonian}
...
it has the highest overlap. In single-reference scenarios, a HF Slater 
determinant will typically have the highest overlap with the exact 
ground state because it minimizes both the absolute energy and the 
correlation energy, which is generated by the mixing between the 
ground- and excited-state Slater determinants. 
...
% SUBSUBSECTION %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
\subsubsection{Variational Derivation of Minimal Decoupling}

...
the Multi-Reference IMSRG (MR-IMSRG) \cite{Hergert:2013ij,Hergert:2014vn,Hergert:2016ng}, 
...
MR-IMSRG(2) flow equations \cite{Hergert:2013ij,Hergert:2014vn,Hergert:2016ng}:
\begin{align}
  \totd{E}{s} &=     
...
on $\lambda^{(4)}$ (see \cite{Hergert:2016ng} for details).
...
energy towards the converged results \cite{Hergert:2016ng}.
...
\cite{Tsukiyama:2012fk,Parzuchowski:2016pi,Hergert:2016ng} --- all we
...
vanish. Thus, we define \cite{Tsukiyama:2012fk,Hergert:2016ng}
...
and experimental data, see \cite{Bogner:2014tg,Hergert:2016ng} for 
...
in about 150 states \cite{Stroberg:2016fk,Hergert:2016ng}. The chiral 
...
Hergert:2016jk,Hergert:2016ng}. The IMSRG implements SRG concepts directly

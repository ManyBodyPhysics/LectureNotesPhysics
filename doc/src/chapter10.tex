...
The use of $\etaO^\text{A/B}$ has additional benefits in numerical
...
For the imaginary-time generator, the IM-SRG(2) flow equations are
...
Clearly, a fixed point of the Wegner flow is reached when $\etaO(s)$

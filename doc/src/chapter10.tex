...
which yields 
\begin{equation}
 d_{\pm 2} = 1\,, \quad d_{\pm 1} = 16\,, \quad d_{0} = 32\,.
\end{equation}
...
The following listing shows the essential part of our Python implementation of
the SRG flow for the pairing model. The full code with additional features can 
be downloaded from 
...
\subsubsection{SRG Flow Equations}
\subsubsection{Induced Interactions}

...
Let us now solve the same problem with an SRG flow. We split the Hamiltonian
...
\begin{figure*}[t]
  ...
  \begin{picture}(1.0000,0.3000)
    \put(0.0000,0.0000){\includegraphics[width=0.49\unitlength]{\fdir/{srg_pairing_diag_delta1.0_g0.5}.pdf}}
    \put(0.5000,0.0000){\includegraphics[width=0.5\unitlength]{\fdir/{srg_pairing_diag-eval_delta1.0_g0.5}.pdf}}    
  \end{picture}

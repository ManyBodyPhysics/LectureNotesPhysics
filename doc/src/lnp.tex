...
\include{chapter7}\label{chap:chapter7}

% Wave function based many-body methods, Morten Hjorth-Jensen,                          \
% Gaute Hagen, Gustav Jansen, Justin G.~Lietz and Samuel Novario                                       \
\include{chapter8}\label{chap:chapter8}

% Variational and diffusion Monte Carlo approaches to the nuclear few-                  \
% and many-body problem, Francesco Pederiva                                             \
\include{chapter9}\label{chap:chapter9}

% In-medium SRG bt Morris, Parzuchowski, Bogner and Hergert et al
\include{chapter10}\label{chap:chapter10}


%  Green's function theory Carlo Barbieri and Adriana Carbone
\include{chapter11}\label{chap:chapter11}


%  Summary chapter by MHJ, MLP and UVK
\include{chapter12}\label{chap:chapter12}

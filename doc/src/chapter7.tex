...
$ \mathbf{R}_{CM}$ and  
%\be\label{jacobi}
%\bm{\eta}_{k-1}=\sqrt{\frac{k-1}{k}}\left(\mathbf{r}_{k}-\frac{1}{k-1}({\mathbf{r}}_{1}+{\mathbf{r}}_{2}+...{\mathbf{r}}_{k-1})\right)\,\,\,\,\,\,\,k=2,3...A\,,
%\ee
...
\be\label{Hlab}
H = H_{CM} + {\cal H} = \frac{\mathbf{P}_{CM}^2}{2 A m} + \sum_{i=1}^{A-1} \frac{\bm{\pi}_i^2}{2m} + V(\bm{\eta}_1,\bm{\eta}_2.... \bm{\eta}_{A-1})\,,
\ee
...
%[1]
\bibitem{EpM11} see for example E. Epelbaum and U.-G. Mei{\ss}ner, Ann. Rev. Nucl. Part. Sci. {\bf 62}, 159 (2012)
...
%[8]  
\bibitem{RGM1} K. Wildermuth, Y.C. Tang, \textit{A Unified Theory of the Nucleus} (Vieweg, 1977);
...
%[11] 
\bibitem{SVM2}  Y. Suzuki, K. Varga, \textit{Stochastic Variational Approach to Quantum Mechnical Few-Body Problems} (Springer-Verlag, Berlin, 1998)

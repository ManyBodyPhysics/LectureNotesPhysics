...
chapters \ref{chap:chapter9} and \ref{chap:chapter10} and serve as
input for the correlation functions employed in Monte Carlo
calculations and in-medium similarity renormalization group theory of
dense fermionic systems.  We provide extensive code examples and

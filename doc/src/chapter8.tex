...
due to lack of momentum conservation. They would also be zero in case a canonical \cite{shavittbartlett2009} Hartree-Fock basis is employed. 
 ...
 while diagram (2) is zero due to lack of momentum conservation. We have two factors of $1/2$ since there are two equivalent pairs fermions (two  particle states and two hole states) starting at the same vertex and ending at the same vertex. The expression for diagram (3)  is 
  \begin{equation}
    ...
    \frac{\langle ij\vert\hat{v}\vert ab\rangle_{AS} \langle
      bk\vert\hat{v}\vert ic\rangle_{AS} \langle ac\vert\hat{v}\vert
      ik\rangle_{AS}}
         {(\varepsilon_i+\varepsilon_j-\varepsilon_a-\varepsilon_b)
  ...
  \begin{equation}
    ...
    \frac{\langle ij\vert\hat{v}\vert cd\rangle_{AS} \langle
      cd\vert\hat{v}\vert ab\rangle_{AS} \langle ab\vert\hat{v}\vert
      ij\rangle_{AS}}
  ...
  \begin{equation}
    ...
    \frac{\langle ab\vert\hat{v}\vert kl\rangle_{AS} \langle
      kl\vert\hat{v}\vert ij\rangle_{AS} \langle ij\vert\hat{v}\vert
      ab\rangle_{AS}}
         {(\varepsilon_i+\varepsilon_j-\varepsilon_a-\varepsilon_b)

...
In our code above we have implemented the matrix-matrix multiplication using a straightforward implementation, fetching each matrix elements when needed. Furthermore, we include an explicit evaluation of the energy denominators as well. 

...
\cite{hh2000,prakash1996,prakash2001,steiner2010}.  In these notes we limit ourselves to matter composed
...
close to $\frac{1}{2}$.  Typical values for ${\cal S} (n)$ at
...
specificied density or Fermi momentum. The recent works of Binder {\em et al} \cite{binder2016} and McElvain and Haxton
\cite{haxton2016} offer interesting perspectives on effective Hamiltonians and choice of basis functions.
...
Refs.~\cite{weinberg1990,ordonez1996,vankolck1999,machleidt2011,epelbaum2009,ekstrom2013,ekstromPRX}).
...
For larger dimensionalities $d$, with $d > 10^5$, iterative Krylov methods \cite{golubvanloan} like Lanczos' \cite{lanczos} or Davidson's \cite{davidson1989,davidson1993} 
...
RPA class of diagrams \cite{blaizot}, as well as the resummation
...
computational methods of preference for doing nuclear physics, with
  ...
  for example the recent reviews by Hagen {\em et al} \cite{hagen2014,hagen2016}.
...
approximated our problem with periodic boundary conditions,
  ...
  finite-size effects \cite{gros1992,gros1996,shepherd2016}. One solution to this problem is by integrating

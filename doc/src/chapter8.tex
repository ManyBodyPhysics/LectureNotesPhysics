...
example
Refs.~\cite{hammer2013,binder2013,hergert2013,roth2012,hagen2012a,hagen2012b,cipollone2013,hebeler2010b,carbone2013}.
...
\begin{lstlisting}[title={\url{https://github.com/ManyBodyPhysics/LectureNotesPhysics/blob/master/doc/src/Chapter8-programs/python/hfnuclei.py}}]
...
\begin{lstlisting}[title={\url{https://github.com/ManyBodyPhysics/LectureNotesPhysics/blob/master/doc/src/Chapter8-programs/python/mbpt.py}}]
#!/usr/bin/python
from sympy import *
from pylab import *
...
\begin{lstlisting}[title={\url{https://github.com/ManyBodyPhysics/LectureNotesPhysics/blob/master/doc/src/Chapter8-programs/cpp/MBPT2/src/main.cpp}}]
...
time.  Increasing to $200$ shells, or $3\times 10^4$ basis states, the percentage of time spent on loading matrix elements for the matrix-matrix multiplication is now reduced to $59\%$. 
...
increasingly important.  With increasing number of particles and single-particle states, one may consider computing matrix elements on the fly.
...
\end{prob}
  ...
  the value of $n$.
  \begin{lstlisting}[title={\url{https://github.com/ManyBodyPhysics/LectureNotesPhysics/blob/master/doc/src/Chapter8-programs/python/spstatescc.py}}]
from numpy import *

...
save us a lot of time when developing a numerical project. In the
...
several approximations, from perturbation theory to second order in
the interaction to specific terms in the solution of the coupled
...
11. It is also important to develop an understanding of how our
...
save you time in case you struggle with odd errors in new version of
your codes. It allows you also to make science reproducible.  Making
...
and perhaps come with considerable improvements and/or finding flaws
or errors you were not aware of. Our codes may run correctly for some
specific case, but may fail totally in cases not tested by
you. Sharing your codes using for example modern version control
...
In the discussions below, you will thus find several links to our common repository for the codes that we have developed when writing 
the various chapters of this text. 

Being able to verify via different tests
that the program we have developed is working correctly  

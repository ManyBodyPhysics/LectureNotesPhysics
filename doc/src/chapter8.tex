...
while MBPT3 includes diagrams (3), (4), (4), (8) and (9) as well. Note that diagram (3) is zero for the pairing model and that diagrams (8) and (9) contribute as well with a canonical Hartree-Fock basis. 
  ...
  $\Delta E_{MBPT2}$ anyltically. This is a very useful  check of our codes since can also be used to check our first CCD iteration.
We restate this expression
  \[
...
However, the disagreement for stronger interaction values hints at  the possibility that many-body perturbation theory may not converge order by order. 
...
The coupled cluster results are included in Fig.~\ref{fig:pairingccmbpt4} where we display the difference between the exact correlation energy and the correlation energy obtained with many-body perturbation theory to fourth order.  
  \begin{figure}
